package com.OpenWorld.dashboard.ui.nav
...
import com.OpenWorld.dashboard.core.Credentials
import com.OpenWorld.dashboard.state.GatePhase
import com.OpenWorld.dashboard.state.GateViewModel
import com.OpenWorld.dashboard.state.Reason
import com.OpenWorld.dashboard.ui.screens.AgentsScreen
import com.OpenWorld.dashboard.ui.screens.BackendDownScreen
import com.OpenWorld.dashboard.ui.screens.ConfigScreen
import com.OpenWorld.dashboard.ui.screens.IndexesScreen
import com.OpenWorld.dashboard.ui.screens.MediaScreen
import com.OpenWorld.dashboard.ui.screens.MemoryScreen
import com.OpenWorld.dashboard.ui.screens.MessagesScreen
import com.OpenWorld.dashboard.ui.screens.OverviewScreen
import com.OpenWorld.dashboard.ui.screens.SettingsScreen
import com.OpenWorld.dashboard.ui.screens.SetupScreen
import com.OpenWorld.dashboard.ui.screens.Splash
import com.OpenWorld.dashboard.ui.screens.TraceScreen
import com.OpenWorld.dashboard.ui.screens.UsersScreen
import com.OpenWorld.dashboard.ui.screens.WorkflowDetailScreen
import com.OpenWorld.dashboard.ui.screens.WorkflowsScreen
...
private fun AppRoot(gateVM: GateViewModel) {
    ...
    ModalNavigationDrawer(
        ...
        Scaffold(
            topBar = { OpenWorldTopBar(title = title, onMenu = openDrawer) },
            containerColor = bg,
        ) { padding ->
            NavHost(
...
@Composable
private fun OpenWorldTopBar(title: String, onMenu: () -> Unit) {
    TopAppBar(
        title = {
            if (title.isNotEmpty()) {
...
private fun DrawerSheetContent(
    ...
    ModalDrawerSheet(drawerContainerColor = panel) {
        ...
        Row(
            ...
            Text("OpenWorld", color = text, fontWeight = FontWeight.Bold, fontSize = 18.sp)
