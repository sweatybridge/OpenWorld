-- =============================================================================
-- pgTAP setup for the attobot RBAC / RLS permission-matrix suite.
...
-- The two AFTER-INSERT triggers on attobot.messages call df.start (a durable
...
ALTER TABLE attobot.messages DISABLE TRIGGER messages_outbound_send_trigger;
ALTER TABLE attobot.messages DISABLE TRIGGER messages_user_loop_trigger;
...
--
-- GUCs (attobot.current_agent_id, .current_chat_id, .current_user_id) are set
